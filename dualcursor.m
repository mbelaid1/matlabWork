function val = dualcursor(state,deltalabelpos,marker_color,datalabelformatfcnh,axh,handles)
...
%   dualcursor off
%
% %Place cursors at x=100 and x=400, place DeltaX/DeltaY display in the upper left
...
if nargin>=1 & isnumeric(state) %First input is x coordinates of markers
    ...
    xl = xlim(axh);
    lim = [xlim ylim];  % Problem using objbounds with hggroup objects, so I have a simple version of my own
...
%                 disp('on case')
        ...
        if nargin<2 | isempty(deltalabelpos)
            deltalabelpos = [.90,0.92 ; .89, 0.85];            %Use defaults
            %[x1 y1; x2 y2]
        end
...
%         end
       ...
       if ~exist('color','var'), color = 'b'; end %set default
        ...
        backgrouncolor = [0.7,0.7,0.7];
        set(th1,'BackgroundColor',backgrouncolor);
        set(th2,'BackgroundColor',backgrouncolor);
        yl = ylim(axh);
        lim = [xlim ylim];
        ...
        %Add the cursors
        ph1 = line([xv1 xv1 xv1],[yl(1) yv1 yl(2)],'LineWidth',1.5, ...
            'Color',color, ...
            'Marker',marker, ...
            'Tag','Cursor', ...
            'UserData',[lineh th1], ...
            'LineStyle','-', ...
            'Parent',axh);
        ph2 = line([xv2 xv2 xv2],[yl(1) yv2 yl(2)], 'LineWidth',1.5,...
            'Color',color, ...
            'Marker',marker, ...
            'Tag','Cursor', ...
            'UserData',[lineh th2], ...
        ...
        deltah(1) = text(deltalabelpos(1,1),deltalabelpos(1,2),['x1 = ' num2str(xv1)], ...
            'Units','Normalized', ...
        ...
        deltah(2) = text(deltalabelpos(1,1),deltalabelpos(1,2)-posDelta,['x2 = ' num2str(xv2)], ...
            'Units','Normalized', ...
            'HorizontalAlignment','left', ...
            'Tag','CursorDeltaText', ...
            'FontSize',textSize, ...
        ...
        deltah(3) = text(deltalabelpos(1,1),deltalabelpos(1,2)-posDelta*2,['y1 = ' num2str(yv1)], ...
            'Units','Normalized', ...
            'HorizontalAlignment','left', ...
            'Tag','CursorDeltaText', ...
            'FontSize',textSize, ...
            'Interpreter','tex', ...
            'Parent',axh);      %dx
        deltah(4) = text(deltalabelpos(1,1),deltalabelpos(1,2)-posDelta*3,['y2 = ' num2str(yv2)], ...
            'Units','Normalized', ...
            'HorizontalAlignment','left', ...
            'Tag','CursorDeltaText', ...
            'FontSize',textSize, ...
            'Interpreter','tex', ...
            'Parent',axh);      %dx
        deltah(5) = text(deltalabelpos(1,1),deltalabelpos(1,2)-posDelta*4,['dx = ' num2str(dx)], ...
            'Units','Normalized', ...
            'HorizontalAlignment','left', ...
            'Tag','CursorDeltaText', ...
            'FontSize',textSize, ...
        ...
        deltah(6) = text(deltalabelpos(1,1),deltalabelpos(1,2)-posDelta*5,['dy = ' num2str(dy)], ...
            'Units','Normalized', ...
            'HorizontalAlignment','left', ...
            'Tag','CursorDeltaText', ...
            'FontSize',textSize, ...
            'Interpreter','tex', ...
            'Parent',axh);      %dx
        deltah(7) = text(deltalabelpos(1,1),deltalabelpos(1,2)-posDelta*6,['dy/dx = ' num2str(dydx)], ...
            'Units','Normalized', ...
            'HorizontalAlignment','left', ...
            'Tag','CursorDeltaText', ...
            'FontSize',textSize, ...
...
%        disp('down case')
        ...
        if strcmp(tag,'CursorText') | strcmp(tag,'Cursor')
...
%                     lim = [xlim ylim];
                ...
                yl = ylim(axh);
                lim = [xlim ylim]; %localObjbounds(get(lh,'Parent'));
                lim = lim(3:4);     %y values only
                yl(isinf(yl)) = lim(isinf(yl));
                ...
                set(deltah(1),'String',['x1 = ' num2str(xy1(1))]);
                set(deltah(2),'String',['x2 = ' num2str(xy2(1))]);
                set(deltah(3),'String',['y1 = ' num2str(xy1(2))]);
                set(deltah(4),'String',['y2 = ' num2str(xy2(2))]);
                set(deltah(5),'String',['dx = ' num2str(dx)]);
                set(deltah(6),'String',['dy = ' num2str(dy)]);
                set(deltah(7),'String',['dy/dx = ' num2str(dy/dx)]);
...
%                 disp('selectline case')
        ...
        %Update the cursors
        dualcursor('update',deltalabelpos,'b',datalabelformatfcnh,axh);
...
%         ylm(isinf(ylm)) = lim(isinf(ylm));
        ...
        set(cursors(cn1),'Color',color);
        set(cursors(cn2),'Color',color);
